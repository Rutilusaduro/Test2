...
export const ENEMY_SPECIES_GROWTH_CHUNKS = [
  // ── HARPY — wings, crop, talons, feathered mass ──
  {
    growthKind: 'harpy',
    texts: [
      "{subject.name}'s wings grow heavy with new softness — primary feathers spreading wider, each beat laboring through thicker air.",
      "Feathered hips thicken on {subject.first}; her talons sink deeper into the ground as plush fat loads her lower half.",
      "{subject.name}'s crop swells beneath feathered collarbone, a greedy pouch rounding outward with every swallowed miracle.",
      "Downy softness creeps along {subject.first}'s wing joints; she flexes and feels drag where flight used to be effortless.",
      "{subject.name}'s belly rounds beneath layered plumage, feathers parting to show pale, jiggling flesh beneath.",
      "Her wingspan seems wider — not from bone, but from fat padding each pinion until she gleams like a harvest idol.",
      "{subject.first}'s thighs plush beneath torn flight-leathers, feathered calves thickening until perch-roosts creak.",
      "{subject.name} preens absently at new softness along her wings; each feathered curve bounces when she laughs.",
    ],
  },
  // ── DRYAD — vines, bark, fertility swell ──
  {
    growthKind: 'dryad',
    texts: [
      "Living vines thicken around {subject.name}'s waist, swelling with her as bark cracks to reveal soft, pear-pale flesh beneath.",
      "{subject.first}'s hips root outward — not into soil, but into plush curves that strain her woven leaf-girdle.",
      "Petals stick to damp skin as {subject.name}'s breasts swell with fertility magic, heavy and round beneath living bark.",
      "Her thighs press together with new vine-wrapped fullness; sap-sweet softness blooms through every green restraint.",
      "{subject.first}'s belly rounds like a ripening gourd, vines creaking as they accommodate divine indulgence.",
      "Bark splinters along {subject.name}'s collarbone; underneath, softness spills free — the grove exhaling in approval.",
      "Fertility magic thickens {subject.first}'s lower body until she sways like a tree in warm wind, hips wide as orchard rows.",
      "{subject.name}'s vine-bound dress splits at the seams; new curves gleam wet with dew and unmistakable appetite.",
    ],
  },
  ...
  // ── FUTURE / RACE ARCHETYPES ──
  {
    growthKind: 'succubus',
    texts: [
      "Infernal curves sharpen then soften — {subject.name}'s tail thickens, hips flaring with obscene, magical precision.",
      "{subject.first}'s wings droop heavy with new plushness; lust given weight, seduction given measurable inches.",
      "Horns catch lantern-light above a swelling bust; {subject.name}'s succubus frame packing on decadent, deliberate fat.",
    ],
  },
  {
    growthKind: 'vampire',
    texts: [
      "Aristocratic pallor warms as {subject.name}'s aristocratic frame softens — eternal hunger finding a new shape.",
      "High collar hides nothing; {subject.first}'s throat and bosom thicken with languid, predatory curves.",
      "{subject.name}'s cape spreads wider to hide new abundance; old-world elegance straining over feast-night pounds.",
    ],
  },
];
