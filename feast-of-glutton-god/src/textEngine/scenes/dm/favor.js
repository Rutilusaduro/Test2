...
registerPool('dm.favor.low', [
  { when: { favorState: 'low', action: 'growth' }, text: [
    'the Fat Goddess\'s attention thins — your next swell may need to wait for a sweeter offering.',
  ...
  { when: { favorState: 'low' }, text: [
    'You feel the Fat Goddess\'s gaze grow distant — favor ebbs like tide before feast.',
    'Your spark still burns, but the Fat Goddess withholds the easy miracles until you indulge yourself.',
  ...
  { when: {}, text: [
    ...
    'Even chosen vessels must eat; the Fat Goddess\'s gift is not a bottomless well.',
...
registerPool('dm.favor.empty', [
  { when: { action: 'special' }, text: [
    ...
    'The signature swell refuses you; the Fat Goddess will not spend what you have not replenished.',
  ...
  { when: {}, text: [
    'the Fat Goddess turns her face away — no favor remains for overworld growth until you eat.',
...
registerPool('dm.special.cooldown', [
  ...
  { when: { archetype: 'devout' }, text: [
    ...
    '"the Fat Goddess\'s mark still warms my skin; return when the day turns."',
