...
export const REGIONS = [
  ...
  },
  {
    ...
    connections: ['fertile_heartlands', 'ancient_temple', 'iron_peak_hold', 'divine_plane_vestibule', 'eternal_feast_hall'],
  ...
  },
  {
    ...
    connections: ['gorgara_cradle', 'eternal_feast_hall'],
    encounters: ['avatar_aurelan', 'sylwen_revenant', 'wheel_incarnate'],
    transformKey: 'vestibule',
    unlockFlag: 'unlock_divine_vestibule',
  },
  {
    id: 'eternal_feast_hall',
    name: 'Eternal Feast Hall',
    zone: 'planar',
    desc: 'A demiplane of endless tables — converted gods dine, legacy abundance swells, and combat is rude.',
    connections: ['gorgara_cradle', 'divine_plane_vestibule'],
    encounters: [],
    transformKey: 'eternal_hall',
    unlockFlag: 'eternal_hall_unlocked',
  },
];
