...
export const ENEMY_TYPES = {
  ...
  dream_echo: {
    ...
    conversion: 0,
    conversionImmune: true,
    desc: "A dream-mirror of your own potential excess — same hunger, softer edges, no mercy for denial.",
    cosmicAbility: "mirror_hunger",
    growthResist: 0.7,
    phases: [{ id: "dream_reflection", hpPct: 0.35, label: "Dream Reflection" }],
    ...MYTHIC,
  },
  avatar_aurelan: {
    id: "avatar_aurelan",
