...
export const CLASS_SPELL_CURRICULUM = {
  wizard: {
    ...
    9: ['grand_transmutation', 'cascade_of_curves', 'throne_of_flesh'],
    10: ['grand_transmutation', 'cascade_of_curves', 'throne_of_flesh'],
    11: ['divine_plump', 'cathedral_of_cream'],
    ...
    15: ['mass_indulgence', 'palace_of_plenty'],
  ...
  cleric: {
    ...
    7: ['eternal_indulgence', 'overflow_cascade', 'matrons_blessing'],
