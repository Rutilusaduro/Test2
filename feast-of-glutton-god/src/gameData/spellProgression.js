...
export const CLASS_SPELL_CURRICULUM = {
  wizard: {
    1: ['expand_minor', 'abundant_berry', 'weight_of_desire'],
    2: ['glutinous_surge', 'form_of_abundance'],
    3: ['overflowing_script', 'pleasurable_pressure'],
    4: ['overflow_cascade', 'form_of_the_devoted'],
    5: ['grand_transmutation', 'cauldron_flesh'],
    7: ['true_overflow'],
    9: ['gorgaras_awakening'],
  },
  cleric: {
    1: ['abundant_berry', 'expand_minor', 'prayer_full_belly'],
    2: ['glutinous_surge', 'feast_of_the_goddess', 'form_of_abundance'],
    3: ['living_altar', 'pleasurable_pressure'],
    4: ['eternal_indulgence', 'overflow_cascade'],
    5: ['gorgara_grand_feast'],
    7: ['true_overflow'],
    9: ['mass_indulgence'],
  },
  bard: {
    1: ['overflowing_charm', 'expand_minor', 'feasts_whisper'],
    2: ['ballad_bottomless', 'glutinous_surge'],
    3: ['feast_song', 'feast_of_the_goddess'],
    4: ['eternal_indulgence'],
    5: ['abundance_crescendo'],
    7: ['overflow_cascade'],
